<?php
    ...
    $posts = [
        ...
        [
            ...
            'img' => 'img-artigo-002.jpg'
        ],
        [
            'id' => 3,
            'title' => 'A importância de lógica de programação',
            'description' => 'A lógica de programação é o ponto inicial de muitos estudantes de programção, será que é importante?',
            'tags' => ['lógica', 'programação', 'algoritmos'],
            'img' => 'img-artigo-003.jpg'
        ],
        [
            'id' => 4,
            'title' => 'Programando em PHP',
